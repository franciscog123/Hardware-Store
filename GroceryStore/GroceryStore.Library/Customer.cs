...
{
    /// <summary>
    /// A customer object. It has a customer's first name, last name, phone number, address, city, state, zip code, country, 
    /// default store, time the last order was placed, and the last store the customer ordered from.
    /// </summary>
